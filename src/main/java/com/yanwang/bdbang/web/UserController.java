package com.yanwang.bdbang.web;

import com.yanwang.bdbang.service.MedShopService;
import com.yanwang.bdbang.service.SecurityService;
import com.yanwang.bdbang.service.MailService;
import com.yanwang.bdbang.service.UserService;
import com.yanwang.bdbang.service.FileService;
import com.yanwang.bdbang.model.Product;
import com.yanwang.bdbang.model.ShoppingCart;
import com.yanwang.bdbang.model.StatisticReport;
import com.yanwang.bdbang.model.Tourguide;
import com.yanwang.bdbang.model.User;
import com.yanwang.bdbang.validator.UserValidator;
...
public class UserController {
    ...
    public String orderdetail(@RequestParam("id") long id, @RequestParam(value = "action", required = false) String action,
        ...
        if (action != null && action.equalsIgnoreCase("addproduct")) {
            ...
            if (pzn != null && amount != null && com.yanwang.bdbang.util.Util.isInteger(amount)) {
